...
- `今天吃什么/中午吃啥/今晚吃啥/中午吃什么/晚上吃啥/晚上吃什么/夜宵吃啥` - 随机推荐今天吃什么
- `菜单/群菜单/查看菜单` - 查看群特色菜单
- `[su] 添加/移除 菜名` - 添加或移除菜品
- `[su] 加菜 菜名` - 添加菜品至基础菜单
- `[su] 基础菜单` - 查看基础菜单
- `[su] 开启/关闭小助手` - 开启或关闭定时提醒
...
```env
# 吃饭小助手配置
WHAT2EAT_PATH=data/what2eat  # 数据存储路径
EATING_LIMIT=3              # 每日食用次数限制
USE_PRESET_MENU=true        # 是否使用预设菜单
USE_PRESET_GREATING=true    # 是否使用预设问候语
GROUPS_ID=[]                # 需要发送提醒的群组ID列表
```
